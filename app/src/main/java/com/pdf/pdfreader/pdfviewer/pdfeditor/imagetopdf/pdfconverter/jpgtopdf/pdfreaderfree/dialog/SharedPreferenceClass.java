...
public class SharedPreferenceClass {
    ...
    private static SharedPreferenceClass instance = null;
    private final SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public SharedPreferenceClass(Context appContext) {
        preferences = PreferenceManager.getDefaultSharedPreferences(appContext);
    }

    public static SharedPreferenceClass getInstance(@NonNull Context context) {
        if (instance != null) return instance;
        else return instance = new SharedPreferenceClass(context);
    }
...
//    		Object value  = gson.fromJso n(jObjString,  mClass);
//    		objects.add(value);
//    	}
//    	return objects;
//    }
