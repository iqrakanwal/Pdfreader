...
public class FullRatingView extends ViewGroup {
    public static final int STAR_EMPTY = R.drawable.ic_staar_off;
    public static final int STAR_HALF = R.drawable.ic_staar_off;
    public static final int STAR_FULL = R.drawable.ic_staar_filleed;
    ...
    public FullRatingView(Context context) {
        this(context, null);
    }
    public FullRatingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public FullRatingView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private ImageView createChild() {
        ...
        imageView.setImageResource(R.drawable.ic_staar_off);
    ...
    public interface OnStarChangeListener {
        void onStarChange(FullRatingView ratingBar, float star);
    }
